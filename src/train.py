...
def train(key, optimizer, opt_state, loss_fn, params, epoch_finished, epochs, batchsize, train_data, valid_data, path):
    ...
    if os.path.getsize(log_filename) == 0:
        f.write("epoch t_loss v_loss t_loss_w v_loss_w t_loss_a v_loss_a t_loss_x v_loss_x t_loss_l v_loss_l\n")
    ...
    for epoch in range(epoch_finished+1, epochs):
        ...
        if epoch % 100 == 0:
            ...
            train_loss_w, train_loss_a, train_loss_x, train_loss_l = train_aux
            valid_loss_w, valid_loss_a, valid_loss_x, valid_loss_l = valid_aux
